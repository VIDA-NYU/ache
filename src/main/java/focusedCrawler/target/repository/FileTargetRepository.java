 ...
 */
@Deprecated
public class FileTargetRepository implements TargetRepository {

    private static final Logger logger = LoggerFactory.getLogger(FileTargetRepository.class);
    private Path location;

    public FileTargetRepository(String location) {
        this.location = Paths.get(location);
    }
    
    public FileTargetRepository(Path location) {
