...
//  private String numBacklink = "&nbq=";   // altavista
  ...
  private LinkNeighborhoodWrapper wrapperLinks;
  ...
  public BacklinkSurfer(StopList stoplist, SimpleWrapper wrapperURL, 
	  ...
	  this.wrapperLinks = new LinkNeighborhoodWrapper(stoplist);
  ...
  public Vector<LinkNeighborhood>[] getLNs() throws MalformedURLException, IOException {
	  return lns;
  }
