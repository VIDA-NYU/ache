...
java -Xmx32g -cp "class/:libs/weka.jar:libs/langdetect.jar:libs/xerces-2.9.1.jar:libs/nekohtml.jar:libs/jsonic-1.2.0.jar:libs/boilerpipe-1.2.0.jar" focusedCrawler.target.TargetStorage $1 $2 > log/target_storage.log 2>&1 &
