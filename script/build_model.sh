...
mkdir -p $OUTPUT
java -cp "class/:libs/weka-stable-3.6.10.jar" focusedCrawler.target.CreateWekaInput config/sample_config/target_storage/target_storage.cfg ${DIRECTORY} ${DIRECTORY}/weka.arff
